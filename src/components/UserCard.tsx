...
export function UserCard({ user }: UserCardProps) {
  ...
  // TODO: to be implemented when user details page will be added
  //  const detailUrl = `/users/${login.uuid}?page=${page}&pageSize=${pageSize}`;

  return (
    /* TODO: can be made as a link to the user detail page */
    <div>
      {/* ── Photo ───────────────────────────────────────────────────────── */}
